...
from PyQt6.QtGui import QPixmap, QImage, QFont, QTextDocument, QTextCursor, QPageLayout
...
class OfflineApp(QMainWindow):
        ...
        self.setStyleSheet("""
            * {
            ...
            QPushButton#ActionBtn {
                height: 40px; font-weight: bold; background-color: #f8f9fa; color: #333; padding: 0 15px; border: 1px solid #ced4da;
            }
            QPushButton#ActionBtn:hover {
                background-color: #e2e6ea;
            }
            QPushButton#ToolBtn {
                background: white; color: black; border: 1px solid #ced4da; font-size: 16px; font-weight: bold; border-radius: 4px; padding: 5px;
            }
    ...
    def init_ui(self):
        ...
        z_label = QLabel("Zoom:")
        z_label.setStyleSheet("color: #333;")
        ...
        self.check_upload.setStyleSheet("color: #3730a3; font-weight: bold;")
        ...
        for topic in self.topics:
            cb = QCheckBox(topic)
            cb.setStyleSheet("font-size: 12px; color: #333;")
        ...
        proj_label.setStyleSheet("color: #333; font-weight: bold;")
        manual_layout.addWidget(proj_label)
        
        self.project_name_input = QLineEdit()
        self.project_name_input.setPlaceholderText("Type or paste Project Name here...")
        self.project_name_input.setStyleSheet("background-color: white; font-size: 14px; padding: 10px; border: 1px solid #ced4da; border-radius: 6px; color: #333;")
        ...
        for label, items in dropdowns:
            ...
            combo.setStyleSheet("color: #333; background: white; border: 1px solid #ced4da; padding-left: 5px;")
            row.addWidget(lbl)
            row.addWidget(combo)
        ...
        notes_label.setStyleSheet("color: #333; font-weight: bold; margin-top: 10px;")
        ...
        self.manual_input.setStyleSheet("background-color: white; font-size: 14px; border: 1px solid #ced4da; border-radius: 6px; padding: 5px; color: #333;")
    ...
    def show_summary_popup(self):
        ...
        text_edit.setStyleSheet("font-size: 14px; line-height: 1.6; padding: 10px; background: white; border: 1px solid #ccc; border-radius: 4px; color: #333;")
    ...
    def preview_pdf(self):
        try:
            ...
            scope_text = scope_val.currentText() if scope_val else "____"
            
            sth_val = getattr(self, 'stakeholder_dropdown', None)
            sth_text = sth_val.currentText() if sth_val else "Both"
            
            cert_val = getattr(self, 'cert_dropdown', None)
            cert_text = cert_val.currentText() if cert_val else "______________________________________________"
            
            task_val = getattr(self, 'task_dropdown', None)
            task_text = task_val.currentText() if task_val else "______________________________________________"
            
            comm_val = getattr(self, 'comm_dropdown', None)
            comm_text = comm_val.currentText() if comm_val else "______________________________________________"
            ...
            html += f"<p>To assign the certification respectively ({scope_text})<br>1) ____<br>2) ____<br>3) ____</p>"
    ...
    def export_docx(self):
        ...
        try:
            ...
            doc.add_paragraph(f"To assign the certification respectively ({scope_text})\\n1) ____\\n2) ____\\n3) ____")
